            ...
            <Box sx={{
                ...
                >
                    {mostOrdered.map((item) => {
                        ...
                        const optimizedSrc = `/img/optimized/${imageName}-800w.webp`;
                        const srcSet = [
                            `/img/optimized/${imageName}-320w.webp 320w`,
                            `/img/optimized/${imageName}-480w.webp 480w`,
                            `/img/optimized/${imageName}-800w.webp 800w`,
                            `/img/optimized/${imageName}-1200w.webp 1200w`,
                            `/img/optimized/${imageName}-1600w.webp 1600w`,
                        ].join(', ');
